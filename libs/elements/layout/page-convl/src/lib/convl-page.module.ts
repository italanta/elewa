...
import { EmptyPageIllustrationComponent } from './components/empty-page-illustration/empty-page-illustration.component';
...
@NgModule({
  ...
  declarations: [
    ConvlPageComponent,
    ConvlNavbarComponent,
    ConvlSideMenuComponent,
    SideMenuFooterComponent,
    ConlvSideNavContainerComponent,
    SubNavBarComponent,
    EmptyPageIllustrationComponent,
  ],
