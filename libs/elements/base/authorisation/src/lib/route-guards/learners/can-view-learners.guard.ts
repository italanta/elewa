...
@Injectable()
export class CanAccessLearnersGuard implements CanActivate, CanLoad
{
  ...
  {
    this.permission$ = this._permissions$$.checkAccessRight((p: CLMPermissions) => p.LearnersSettings.CanViewLearners);
