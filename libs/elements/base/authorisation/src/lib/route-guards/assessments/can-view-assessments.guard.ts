...
@Injectable()
export class CanAccessAssessmentsGuard implements CanActivate, CanLoad
{
  ...
  {
    this.permission$ = this._permissions$$.checkAccessRight((p: CLMPermissions) => p.AssessmentsSettings.CanViewAssessments);
