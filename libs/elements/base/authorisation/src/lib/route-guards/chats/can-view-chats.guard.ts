...
@Injectable()
export class CanAccessChatsGuard implements CanActivate, CanLoad
{
  ...
  {
    this.permission$ = this._permissions$$.checkAccessRight((p: CLMPermissions) => p.ChatsSettings.CanViewChats);
