...
@Injectable()
export class CanAccessBotsGuard implements CanActivate, CanLoad
{
  ...
  {
    this.permission$ = this._permissions$$.checkAccessRight((p: CLMPermissions) => p.BotsSettings.CanViewBots);
