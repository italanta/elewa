...
import { ChannelDataService, EngineBotManager, MessagesDataService } from '@app/functions/bot-engine';
...
import { WhatsappIncomingMessageParser } from 'libs/functions/bot-engine/whatsapp/src/lib/io/incoming-message-parser/whatsapp-api-incoming-message-parser.class';
...
export class MessengerReceiveMsgHandler extends FunctionHandler<IncomingWhatsAppMessage, RestResult>
{
  ...
  public async execute(payload: any, context: HttpsContext, tools: HandlerTools) 
  {
    ...
    console.log(`Received Messenger msg ${payload}`);
