...
{ 
  ...
  protected abstract parseInStickerMessage(incomingMessage: IncomingMessagePayload): Message
 ...
 */
  parse(messageType: MessageTypes, incomingMessage: IncomingMessagePayload): Message
  {
    ...
    switch (messageType) 
    {
      ...
      case MessageTypes.STICKER:      parser = this.parseInStickerMessage; break;
      default:                        return null
    }
