import { AuthBlockingEvent, AuthUserRecord, beforeUserCreated, BlockingOptions,  } from "firebase-functions/v2/identity";
 ...
 * PubSub registrar.
 */
export class BeforeUserCreatedRegistrar extends FunctionRegistrar<AuthUserRecord, void>
{
