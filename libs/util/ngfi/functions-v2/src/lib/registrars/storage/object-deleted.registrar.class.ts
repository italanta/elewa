...
import { StorageOptions, StorageObjectData, onObjectDeleted } from 'firebase-functions/v2/storage';
...
/**
 * Object deleted registrar.
 */
export class CloudStorageObjectDeletedRegistrar extends FunctionRegistrar<StorageObjectData, void>
{
