...
@Component({
  selector: 'app-after-inactivity',
  templateUrl: './after-inactivity.component.html',
  styleUrls: ['./after-inactivity.component.scss'],
})
export class AfterInactivityComponent {
