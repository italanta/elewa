...
@Directive({
  selector: '[hasDeleteAccess]'
})
export class HasDeleteAccessDirective
{
  isRendered = false;
  ...
  @Input() set hasDeleteAccess(claim: AppClaimDomains)
  {
  ...
  {
    if(right === AccessRights.Delete && !this.isRendered)
    {
