 ...
 */
export function _OpenEndedQuestionBlockDecoratePlumb(block: OpenEndedQuestionBlock, comp: ComponentRef<any>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<any> 
{
