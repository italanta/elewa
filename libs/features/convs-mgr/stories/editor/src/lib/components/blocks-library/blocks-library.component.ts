...
export class BlocksLibraryComponent implements OnInit, OnDestroy {
  ...
  blockTemplates: StoryBlock[] = [
    ...
    { id: 'webhook-block' , type: StoryBlockTypes.WebhookBlock, message: 'Webhook', blockIcon:this.getBlockIcon(StoryBlockTypes.WebhookBlock), svgIcon:this.getSvgIcon(StoryBlockTypes.WebhookBlock), blockCategory: 'questions-block' } as WebhookBlock,
