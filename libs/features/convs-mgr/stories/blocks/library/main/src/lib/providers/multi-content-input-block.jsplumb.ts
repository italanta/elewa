 ...
 */
export function _MultiContentInputBlockDecoratePlumb(block: MultiContentInputBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<BlockComponent> 
{
