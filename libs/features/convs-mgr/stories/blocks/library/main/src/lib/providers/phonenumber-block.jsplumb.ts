 ...
 */
export function _EmailBlockDecoratePlumb(block: PhoneMessageBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<BlockComponent> 
{
