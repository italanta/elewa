...
import { LinkStoryBlock } from "@app/model/convs-mgr/stories/blocks/messaging";
 ...
 */
export function _CreateLinkStoryBlockForm(_fb: FormBuilder, blockData: LinkStoryBlock): FormGroup {
  return _fb.group({
    id: [blockData?.id! ?? ''],
    storyId: [blockData?.message! ?? ''],
