 ...
 */
export function _MultipleBlockDecoratePlumb(block: MultipleInputMessageBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<BlockComponent> 
{
