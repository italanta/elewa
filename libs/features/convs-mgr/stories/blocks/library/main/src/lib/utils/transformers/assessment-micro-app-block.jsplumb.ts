 ...
 */
export function _AssessmentMicroappBlockDecoratePlumb(block: AssessmentMicroAppBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<BlockComponent> 
{
