 ...
 */
export function _FailBlockDecoratePlumb(block: FailMessageBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance): ComponentRef<BlockComponent> {
