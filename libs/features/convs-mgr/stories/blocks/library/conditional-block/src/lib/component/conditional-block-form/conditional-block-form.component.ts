...
@Component({
  selector: 'app-conditional-block-form',
  templateUrl: './conditional-block-form.component.html',
  styleUrl: './conditional-block-form.component.scss',
})
export class ConditionalBlockFormComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  addExistingOptions(optionItem?: ButtonsBlockButton<any>) {
