 ...
 */
export function _LocationInputBlockDecoratePlumb(block: LocationInputBlock, comp: ComponentRef<BlockComponent>, jsPlumb: BrowserJsPlumbInstance) : ComponentRef<BlockComponent> 
{
